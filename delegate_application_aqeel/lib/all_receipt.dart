...
class AllReceipt extends StatefulWidget {
  const AllReceipt({super.key});

  @override
  State<AllReceipt> createState() => _AllReceiptState();
}
...
class _AllReceiptState extends State<AllReceipt> {
  ...
  Future<void> fetchCustomers(String name) async {
    ...
    final response = await http.get(Uri.parse(
        '${linkDelegate}CustomersPayments/GetCustomersPaymentsCustomerName/id=$delegateId&&customerName=$name'));
                                ...
                                children: [
                                  Text('${customer['customerName']}',
                                      style: const TextStyle(
                                          ...
                                          fontSize: 16)),
                                  Text(formatDate(customer['paymentDate']),
                                      style: const TextStyle(
                                          color: Colors.grey,
                                          fontFamily: 'Cairo',
                                          fontSize: 12)),
