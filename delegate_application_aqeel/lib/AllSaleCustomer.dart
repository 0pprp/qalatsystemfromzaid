...
class AllSaleCustomer extends StatefulWidget {
  final int customerId;

  const AllSaleCustomer({super.key, required this.customerId});

  @override
  _AllSaleCustomerState createState() => _AllSaleCustomerState();
}

class _AllSaleCustomerState extends State<AllSaleCustomer> {
  ...
  Future<void> fetchCustomers() async {
    ...
    final response = await http.get(Uri.parse(
        '${linkDelegate}CustomersSales/GetCustomersSalesCustomer/${widget.customerId}'));
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: const Text('مبيعات العميل',
