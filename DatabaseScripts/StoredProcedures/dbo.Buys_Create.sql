...
DECLARE @AddToStoreID int;
SET @AddToStoreID = IDENT_CURRENT('AddToStores');
...
INSERT INTO [dbo].[Activities]
     ...
     VALUES
           ...
           ,'false'
           ,NEWID() )
select * from View_Buys where BuyID=@BuyID
