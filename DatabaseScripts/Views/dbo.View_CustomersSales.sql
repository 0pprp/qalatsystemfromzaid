 ...
 CREATE view [dbo].[View_CustomersSales]
 as
...
SELECT 
    ...
    ISNULL(dbo.CustomersSales.DiscountAmountTotal*1448,0) as DiscountAmountTotalDenar,
    ISNULL(dbo.CustomersSales.DiscountAmountTotalDay*1448,0) as DiscountAmountTotalDayDenar,
    ...
    ROUND(
        ItemsSalesData.AmountTotalSalesDenar - ISNULL(ReceiptsData.ReceiptsTotal, 0),
        -3
    ) AS AmountRemaining,
