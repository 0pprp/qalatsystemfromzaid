...
SELECT 
    ...
    ISNULL(SUM(CASE WHEN wd.RowNum = 91 THEN cp.TotalAmount ELSE 0 END), 0) AS Amount91,
    ISNULL(SUM(CASE WHEN wd.RowNum = 92 THEN cp.TotalAmount ELSE 0 END), 0) AS Amount92,
    ISNULL(SUM(CASE WHEN wd.RowNum = 93 THEN cp.TotalAmount ELSE 0 END), 0) AS Amount93,
    ISNULL(SUM(CASE WHEN wd.RowNum = 94 THEN cp.TotalAmount ELSE 0 END), 0) AS Amount94,
    ISNULL(SUM(CASE WHEN wd.RowNum = 95 THEN cp.TotalAmount ELSE 0 END), 0) AS Amount95,
    ISNULL(SUM(CASE WHEN wd.RowNum = 96 THEN cp.TotalAmount ELSE 0 END), 0) AS Amount96,
    ISNULL(SUM(CASE WHEN wd.RowNum = 97 THEN cp.TotalAmount ELSE 0 END), 0) AS Amount97,
    ISNULL(SUM(CASE WHEN wd.RowNum = 98 THEN cp.TotalAmount ELSE 0 END), 0) AS Amount98,
    ISNULL(SUM(CASE WHEN wd.RowNum = 99 THEN cp.TotalAmount ELSE 0 END), 0) AS Amount99,
    ISNULL(SUM(CASE WHEN wd.RowNum = 100 THEN cp.TotalAmount ELSE 0 END), 0) AS Amount100
FROM 
    dbo.Customers c
LEFT JOIN 
