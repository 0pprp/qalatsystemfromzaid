namespace BE_DelegateWebApplication.DTO
{
    public class CustomerGetDTO
    {
        ...
        public DateTime? DateSaleBalance { get; set; }
        public DateTime? LastPaymentDate { get; set; }
        public double? AmountTotalSalesBalance { get; set; }
        public double? CostTotalSalesBalance { get; set; }
        public double? AmountDaySalesBalance { get; set; }
        public double? ReceiptsTotalBalance { get; set; }
        public double? AmountRemainingBalance { get; set; }
        public string BalanceNames { get; set; } = null!;
        public double? ReceiptRateBalance { get; set; }
        public int NumberOfDayBalance { get; set; }
        public double? AccumulatedDevice { get; set; }
        public double? AccumulatedBalance { get; set; }
        public int? CountReceiptDevice { get; set; }
        public int CountReceiptBalance { get; set; }
