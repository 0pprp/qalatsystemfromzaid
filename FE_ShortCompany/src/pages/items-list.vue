...
const colSlots = {
  itemPriceDenar: 'item.itemPriceDenar',
  itemCostDenar: 'item.itemCostDenar',
  amountDayDenar: 'item.amountDayDenar',
  priceTotalItem: 'item.priceTotalItem',
  costTotalItem: 'item.costTotalItem',
  itemPriceSales: 'item.itemPriceSales',
  itemCostSales: 'item.itemCostSales',
  update: 'item.update',
  delete: 'item.delete',
}
