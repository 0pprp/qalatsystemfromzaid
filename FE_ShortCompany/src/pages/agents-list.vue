...
// دالة فتح Dialog التعديل
function openAddDialog(delegateID) {
...
const colSlots = {
  ...
  numberOfCustomer: 'item.numberOfCustomer',
  numberOfCustomerIsZero: 'item.numberOfCustomerIsZero',
  numberOfCustomerIsNotZero: 'item.numberOfCustomerIsNotZero',
  numberOfCustomerIsLegal: 'item.numberOfCustomerIsLegal',
  amountTotal: 'item.amountTotal',
  amountCost: 'item.amountCost',
  amountDay: 'item.amountDay',
  amountRecever: 'item.amountRecever',
    ...
    <VForm>
      ...
      <VRow>
        ...
        >
          ...
          <template #[colSlots.numberOfCustomer]="{ item }">
            <VChip
              color="primary"
              size="small"
          ...
          <template #[colSlots.numberOfCustomerIsZero]="{ item }">
            <VChip
              color="success"
              size="small"
              class="font-weight-bold"
          ...
          <template #[colSlots.numberOfCustomerIsNotZero]="{ item }">
            <VChip
              color="error"
              size="small"
              class="font-weight-bold"
          ...
          <template #[colSlots.numberOfCustomerIsLegal]="{ item }">
            <VChip
              color="warning"
              size="small"
              class="font-weight-bold"
    ...
    <VCard class="pa-2">
      <div class="dialog-header pa-4 d-flex align-center justify-space-between">
        <div class="d-flex align-center gap-3">
          ...
          <div>
            ...
            <span class="text-caption text-medium-emphasis">أدخل بيانات المندوب الجديد</span>
          </div>
        </div>
        <VBtn
          icon
      ...
      <VCardActions>
        ...
        <VBtn
          ...
          :disabled="!newDelegate.delegateName"
          @click="addDelegate"
        >
          إضافة
        </VBtn>
