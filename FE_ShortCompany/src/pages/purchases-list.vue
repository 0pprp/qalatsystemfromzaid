...
async function fetchCashBoxes() {
  try {
    ...
    cashBoxesOptions.value = response.data
  } catch (error) {
...
const colSlots = {
  ...
  totalAmountDenar: 'item.totalAmountDenar',
  amountSpentDenar: 'item.amountSpentDenar',
