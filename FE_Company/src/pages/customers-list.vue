        ...
        >
          ...
          <template #item.profile="{ item }">
            <VBtn
              ...
              @click="router.push({ name: 'customer-profile', query: { customerID: item.customerID } })"
            >
              الملف
            </VBtn>
          </template>
