...
const headers = [
  ...
  { title: 'عدد المصفرين', key: 'numberOfCustomerZero' },
  { title: 'سعر بيع المصفرين', key: 'amountPriceZero' },
  { title: 'قسط المصفرين', key: 'amountDayZero' },
]
...
async function fetchStats() {
  try {
    ...
    const response = await axios.get(`${apiUrl}Delegates/Delegates_Statistics/${fromDate}&&${toDate}`, { headers: authHeader })
